...
credits = [
    300,200,300,400,500,600,600,600,800,300,300,200,300,400,600,600,700,800,1200,300,10000
]
...
def handle_submit(group, time, question):
    ...
    try:
        ...
        return "成功提交unix时间戳为{}的题目 {} 目前累计获得积分{}, 余额{}".format(int(time) / 1000000, titles[question_id], group.credit,get_balance(group)  )
